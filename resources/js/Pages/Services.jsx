...
export default function Services() {
  const [services,setServices] = useState([
    ...
    description:'Every child is unique, and some little ones need extra care when it comes to sleep. Our special needs sleep consultations are tailored to children with developmental or medical considerations. We provide compassionate, adaptive strategies to support your child`s individual needs, helping the whole family get better rest'
    },
    {
    image:"images/services/mom-holds-happy-baby-while-drinking-coffee.jpg",
    title:"Postpartum Doula Services",
    description:`Our postpartum doula services offer holistic, personalized care to support your physical and emotional well-being. We help with newborn care, infant soothing, breastfeeding, and providing light household assistance. Whether you need a comforting presence or practical support, we’re here to ensure your transition to parenthood is as smooth and stress-free as possible.`
    },
    {
      image: "images/services/Breastfeeding-Consultation.webp",
    ...
    {
      image: "images/services/clothing-the-birth-florida-e1617732470869.webp",
    ...
    return (
        <div>
          <Seo title="Our Services"  description="At Nested Nurturers, we provide compassionate prenatal, birth, and postpartum doula support for families in the Bay Area, California. Our personalized care helps parents feel confident, supported, and empowered during the early stages of parenthood" url="/services"/>
            <Header />
